const CACHE = 'gefaz-calda-v1';
const ASSETS = ['./', './index.html', './app.css', './app.js', './kb.js', './engine.js', './sdk.js', './manifest.json', './icon-192.png', './icon-512.png', './data/agrofit-index.json'];
