...
* **Cruzamento vazão × pressão** — com um par conhecido (vazão medida numa pressão medida) o app
  ...
  não de manômetro.
* **Busca livre no inventário** — a caixa no topo de *3 · Ponta* (e a do *Catálogo de pontas*, no fim da aba) aceita vários termos em qualquer ordem: marca, modelo, tipo de jato, tamanho, cor ISO, ângulo ou o código que o operador diz de cabeça (`XR 11002`, `AIXR 110-03`, `8002`, `Albuz cone`, `amarelo`). Sem tamanho na busca aparecem as famílias; com tamanho, cor ou ângulo, as pontas exatas com vazão de referência — um toque seleciona marca, modelo, tamanho e ângulo e a regulagem já recalcula. As pontas cadastradas em *Minha ponta* entram na busca (★), e, se nada serve, o último item da lista leva ao cadastro com o texto digitado.
